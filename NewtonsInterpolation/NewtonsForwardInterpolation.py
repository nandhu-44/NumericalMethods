# Write a program to estimate the value of a function for any intermediate value of the independent variable using Newton's forward interpolation formula.
